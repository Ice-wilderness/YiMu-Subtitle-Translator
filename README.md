...
**差异：**
- 其他方案把专有名词 "AI Engineer" 错译为"AI工程师"，丢失了会议名称
- 译幕保留了专有名词原文，翻译更准确、更符合中文表达习惯
...
2. **Faster-Whisper-XXL**（语音识别引擎）— 从 [Purfview/whisper-standalone-win](https://github.com/Purfview/whisper-standalone-win/releases) 下载，解压后将 `faster-whisper-xxl.exe` 放到项目 `tools/` 目录或系统 PATH 中
